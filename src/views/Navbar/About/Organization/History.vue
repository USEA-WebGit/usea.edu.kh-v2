            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-10">
                    ...
                    <div class="grid grid-cols-2 justify-items-center items-center">
                        <div class="text-justify 2xl:text-lg xl:text-lg lg:text-sm">
                            <ul class="flex flex-col gap-3">
                                <li>The picture of the golden rice panicles around the circle symbolizes the university’s strength, development and sustainability.</li>
                                ...
                                <li>The picture of the light blue globe inside the circle represents fame, national and international recognition, and regional  and global integration.</li>
                                <li>The pictures of the blue hat and spearhead on the book symbolize high quality education and research, resulting in excellent leadership with professional ethics, creativity, social understanding, and commitment to promoting national.</li>
                            </ul>
                        </div>

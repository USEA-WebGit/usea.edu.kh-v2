        ...
        <div>
            ...
            <div class="mt-10 mb-10">
                ...
                <table>
                    ...
                    <tr>
                        <td>មុខវិជ្ជារួម (Common Subjects)</td>
                        <td>១២ ក្រេឌីតសិក្សា</td>
                        <td>១២ ក្រេឌីតសិក្សា</td>
                    </tr>
                    <tr>
                        <td>មុខវិជ្ជាជំនាញ (Major Subjects)</td>
                        <td>១៥ ក្រេឌីតសិក្សា</td>
                        <td>១២ ក្រេឌីតសិក្សា</td>
                    </tr>
                    <tr>
                        <td>មុខវិជ្ជាជ្រើសរើស (Elective Subjects)</td>
                        <td>១២ ក្រេឌីតសិក្សា</td>
                        <td>៦ ក្រេឌីតសិក្សា</td>
                    </tr>
                     <tr>
                        <td>សិក្ខាសាលា (Seminar)</td>
                        <td>១ ក្រេឌីតសិក្សា</td>
                        <td>១ ក្រេឌីតសិក្សា</td>
                    </tr>
                    <tr>
                        <td>និក្ខេបបទ (Master Thesis)</td>
                        <td>-</td>
                        <td>១២ ក្រេឌីតសិក្សា </td>
                    </tr>
                </table>

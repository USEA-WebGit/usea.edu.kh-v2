<template>
    <DepartmentPage :department="departmentKhmer" />
</template>
...
const departmentKhmer = {
    ...
    majors: {
        ...
        bachelor: [
            { name: "Khmer LiteratureTeaching Chinese as a Foreign Language (TCFL)", image: "https://cdn.flyonui.com/fy-assets/components/card/image-5.png" },
        ]
    },

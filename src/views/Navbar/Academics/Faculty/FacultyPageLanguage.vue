        ...
        <div>
            <section class="mb-12">
                <div class="bg-usea_secondary flex flex-col justify-center items-center mb-5">
                    <span class="text-white text-[2rem] font-bold">ABOUT FACULTY</span>
            ...
            <section class="mb-12">
                <div class="bg-usea_secondary flex flex-col justify-center items-center mb-5">
                    <span class="text-white text-[2rem] font-bold">FACULTY'S MEMBERS</span>
                    <div class="h-1 w-[5%] bg-usea_secondary"></div>
                </div>
            ...
            <section>
                ...
                <div class="grid 2xl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 gap-4 mb-5">
                    <div v-for="(activity, index) in faculty.activities" :key="index">
                        <div class="overflow-hidden">

<template>
    <div class="bg-gray-200 p-5 flex flex-col gap-5 2xl:text-xl xl:text-xl lg:text-sm rounded-md sticky top-28 h-max">
        <div class="flex flex-col">
            ...
            <router-link
                :to="{name: 'faculty-page', params: {facultyName: 'arts-humanities-languages'}}"
                class="link"
            ...
            <router-link
                :to="{ name: 'faculty-staff', params: {facultyStaff: 'arts-humanities-languages'} }"
                class="link"
        ...
        <div class="flex flex-col">
            <span class="text-[#002060] text-xl font-bold mb-5">Department +</span>
            <router-link

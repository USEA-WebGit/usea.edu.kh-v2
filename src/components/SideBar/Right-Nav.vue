<template>
  ...
  >
    ...
    <section class="space-y-3">
      ...
      >
        <span class="text-[#002060] text-xl font-bold">Organization Info +</span>
        <svg class="h-5 w-5 transition-transform" :class="open.org ? 'rotate-180' : ''" viewBox="0 0 20 20" fill="currentColor">
      ...
      <nav v-show="open.org" class="flex flex-col">
        <RouterLink
          :to="{ name: 'history' }"
          class="nav-link"
    ...
    <section class="space-y-3">
      ...
      >
        <span class="text-[#002060] text-xl font-bold">Governance &amp; Accreditation +</span>
        <svg class="h-5 w-5 transition-transform" :class="open.gov ? 'rotate-180' : ''" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.128l3.71-3.9a.75.75 0 011.08 1.04l-4.24 4.45a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd"/>
        </svg>
      </button>

      <nav v-show="open.gov" class="flex flex-col">
        <RouterLink
          :to="{ name: 'message' }"
          class="nav-link"
    ...
    <section class="space-y-3">
      ...
      >
        <span class="text-[#002060] text-xl font-bold">Information +</span>
        <svg class="h-5 w-5 transition-transform" :class="open.info ? 'rotate-180' : ''" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.128l3.71-3.9a.75.75 0 011.08 1.04l-4.24 4.45a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd"/>
        </svg>
      </button>

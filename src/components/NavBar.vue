<template>
  <div>
    ...
    >
      <div
        class="flex-1 flex 2xl:justify-center xl:justify-center lg:justify-center md:justify-between md:px-5 sm:justify-between sm:px-5 sm:items-center justify-between items-center px-5"
      >
        <!-- Desktop Logo -->
      ...
      >
        <ul class="flex align-top gap-8 relative">
            ...
            >
                ...
                <ul class="text-lg text-gray-500">
                  <li class="flex gap-2">
                    <router-link :to="{ name: 'history' }" class="link"
                      >History & Logo Meaning</router-link
                    >
                  </li>
                  <li class="flex gap-2">
              ...
              <div class="mega-menu-item px-12 w-full">
                ...
                <ul class="text-lg text-gray-500">
                  ...
                  >
                  <router-link :to="{ name: 'board-trustee' }"
                    ><li class="flex gap-2">Board of Trustees</li></router-link
                  >
              ...
              <div class="mega-menu-item px-12 w-full">
                ...
                <ul class="text-lg text-gray-500">
                  <router-link :to="{ name: 'news-events' }"
                    ><li class="flex gap-2">News & Events</li></router-link
                  >
                  <router-link :to="{ name: 'faq' }"
                    ><li class="flex gap-2">FAQ</li></router-link
                  >
                  <router-link :to="{ name: 'contact' }"
                    ><li class="flex gap-2">Contact</li></router-link
                  >
                </ul>
              </div>
            </ul>
              ...
              <div class="mega-menu-item">
                ...
                <ul class="text-lg text-gray-500">
                  ...
                  <router-link
                    :to="{
                      name: 'faculty-page',
                      params: { facultyName: 'science-technology' },
                    }"
                    ><li class="flex gap-2">
                  ...
                  <router-link
                    :to="{
                      name: 'faculty-page',
                      params: { facultyName: 'social-science-law' },
                    }"
                    ><li class="flex gap-2">
                  ...
                  <router-link
                    ...
                    ><li class="flex gap-2">
                      Faculty of Art, Humanities & Language
                    </li></router-link
                  >
                </ul>
              </div>
              <div class="mega-menu-item px-12 w-full">
                ...
                <ul class="text-lg text-gray-500">
                  <router-link
                    :to="{
                      name: 'faculty-page',
                      params: { facultyName: 'international-college' },
                    }"
                    ><li class="flex gap-2">
                  ...
                  <router-link :to="{ name: 'short-course' }"
                    ><li class="flex gap-2">Short Course</li></router-link
                  >
                </ul>
              </div>
              <!-- <div class="mega-menu-item px-12 w-full">
          ...
          <router-link :to="{ name: 'partnership' }"
            ><li class="nav-item pb-10">PARTNERSHIP</li></router-link
          >
          ...
          <li class="nav-item group relative pb-10">
            RESEARCH
            <div
              class="mega-menu hidden absolute top-full left-0 w-max bg-white p-7 z-50 rounded-md"
            >
              <ul class="text-lg text-gray-500">
                <router-link :to="{ name: 'research' }"
                  ><li class="flex gap-2">Research Project</li></router-link
                >
    ...
    >
      ...
      <ul
        class="w-full space-y-4 text-xl font-bold text-usea_secondary flex flex-col"
      >
        <!-- About Menu -->
        <li>
          <div
          ...
          <transition name="slide">
            ...
            >
              <router-link
                ...
                ><li>History & Logo Meaning</li></router-link
              >
              <router-link
                :to="{ name: 'vision' }"
                @click="navigateAndClose('vision')"
                ><li>Vision & Mission</li></router-link
              >
              <router-link
                :to="{ name: 'location' }"
                @click="navigateAndClose('location')"
                ><li>Location</li></router-link
              >
              <router-link
                :to="{ name: 'message' }"
                @click="navigateAndClose('message')"
                ><li>Message from President</li></router-link
              >
              <router-link
                :to="{ name: 'board-trustee' }"
                @click="navigateAndClose('board-trustee')"
                ><li>Board of Trustees</li></router-link
              >
              <router-link
                :to="{ name: 'recognition' }"
                @click="navigateAndClose('recognition')"
                ><li>Recognition & Accreditation</li></router-link
              >
              <router-link
                :to="{ name: 'news-events' }"
                @click="navigateAndClose('news-events')"
                ><li>News & Events</li></router-link
              >
              <router-link
                :to="{ name: 'faq' }"
                @click="navigateAndClose('faq')"
                ><li>FAQ</li></router-link
              >
              <router-link
                :to="{ name: 'contact' }"
          ...
          <transition name="slide">
            ...
            >
              <router-link
                ...
                @click="navigateAndClose('economics-business-tourism')"
                ><li>Faculty of Economics, Business & Tourism</li></router-link
              >
              <router-link
                :to="{
                  name: 'faculty-page',
                ...
                @click="navigateAndClose('science-technology')"
                ><li>Faculty of Sciences & Technology</li></router-link
              >
              <router-link
                :to="{
                  name: 'faculty-page',
                ...
                @click="navigateAndClose('social-science-law')"
                ><li>Faculty of Social Science & Law</li></router-link
              >
              <router-link
                :to="{
                  name: 'faculty-page',
                  params: { facultyName: 'arts-huminaties-languages' },
                }"
                @click="navigateAndClose('arts-huminaties-languages')"
                ><li>Faculty of Art, Humanities & Language</li></router-link
              >
              <router-link
                :to="{
                  name: 'faculty-page',
              ...
              <router-link
                :to="{ name: 'short-course' }"
                @click="navigateAndClose('short-course')"
                ><li>Short Course</li></router-link
              >
            </ul>
          </transition>
        </li>
        ...
        <li>
          ...
          <transition name="slide">
            ...
            >
              <router-link
                :to="{ name: 'partnership' }"
                @click="navigateAndClose('local-partnership')"
                ><li>Partnership</li></router-link
              >
        ...
        <router-link
          :to="{ name: 'research' }"
          @click="navigateAndClose('research')"
          ><li>Research</li></router-link
        >

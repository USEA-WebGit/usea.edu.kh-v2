...
export const faculties = {
  "economics-business-tourism": {
    ...
    description:
      "Faculty of Economics Business & Tourism aims to provide specialized education...",
    image: demoCard,
    departments: [
      {
    ...
    members: [
      ...
      },
      {
        name: "Mr. Ne Sokna",
        position:
          "Head of Department of Economics and Head of USEA Career Center",
        image: nesokna,
      },
      {
        name: "Mr. Luch Reaksmey",
        position: "Head of Academic Office",
        image: luchreaksmey,
      },
      {
        name: "Mr. Hoeurm Sopha",
        position:
          "Deputy Head of Academic Office in Charge of Examination Affairs",
        image: hoeurmsopha,
      },
      {
        name: "Mrs. Kang Chhorvy",
        position:
          "Deputy Head of Academic Office in Charge of Lecturer Affairs",
        image: kangchhorvy,
      },
      {
        name: "Mrs. Horm Makara",
        position: "Dean of Faculty of Economics Business & Tourism",
        image: hormmakara,
      },
      {
        name: "Mrs. Phun Sreypov",
        position: "Staff of Lecturers' Affairs",
        image: phunsreypov,
      },
      {
        name: "Mrs. Seng Chanleap",
    ...
    departments: [
      {
        ...
        image: departmentbg,
        params: { departmentName: "department-architecture" },
      },
      {
        name: "Department of Information and Communication Technology",
        image: departmentbg,
        params: { departmentName: "department-technology" },
      },
      {
        name: "Department of Mathematics and Science",
        image: departmentbg,
        params: { departmentName: "department-mathematic" },
      },
    ],
    members: [
      {
  ...
  "social-science-law": {
    ...
    description:
      "Faculty of Social Science & Law aims to provide specialized education...",
    image: demoCard,
    departments: [
      {
        name: "Department of Laws",
        image: departmentbg,
        params: { departmentName: "department-laws" },
      },
      {
        name: "Department of Social and Science",
        image: departmentbg,
        params: { departmentName: "department-social-science" },
      },
    ],
    members: [
      {
        name: "Mr. Leang Taingsoth",
        position: "Dean of Faculty of Social Science and Law",
        image: leangtaingsoth,
      },
      {
        name: "Mr. Eom Rathanak",
        position: "Head of Department of Laws",
        image: eomrathanak,
      },
    ],
    activities: [{ image: demoCard }, { image: demoCard }, { image: demoCard }],
